...
const Form = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setShowContent(true)
        console.log('si ves esto es porque funciono la validacion de tanto la imagen como los inputs')
    }
    ...
    return (
        <div className='flex flex-col min-h-screen'>
            ...
            <div className='flex flex-col flex-1'>
                <Hero isHidden={showContent} />

                {showContent ?
                    <div>
                        <img src={TicketInfo} alt="" className='w-[90%] mx-auto ' />
                        <img src={BgFooter} alt="" className='mt-auto' />
                    </div>
                    :
                    <>
